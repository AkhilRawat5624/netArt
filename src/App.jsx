  ...
  return (
    <>
      <div className="header">
        <img src="src/assets/logo.png" alt="" className='banner' />
      </div>
      <div className="description">
        <div className="trophy">
          <img src="src/assets/1.png" alt="" className='trophy' />
        </div>
        <div className="content">
          ...
          <img src="src/assets/2.png" alt="" className='pic2'/>
      ...
      <div className="supplies">
        <img src="src/assets/3.png" alt="" className='supplies-img' />
